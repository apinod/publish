(function () {
	"use strict";
	angular.module("app.chart.morrisChart.directives", [])
           	...
           	return {
           		...
           		link: function (scope, ele) {
           			...
           			switch (data = scope.data, type = scope.type) {
           				case "line":
           					return options = angular.extend({ element: ele[0], data: data }, scope.options),
           				...
           				case "donut":
           					return options = angular.extend({ element: ele[0], data: data },
                                scope.options),
